					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php $sql = "SELECT id from carwashbooking";
...
<a href="new-booking.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>New Bookings</h3>
							<?php $sql1 = "SELECT id from carwashbooking  where status='New'";
...
<?php $sql3 = "SELECT id from carwashbooking  where status='Completed'";
						...
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Washing Points</h3>
												<?php $sql5 = "SELECT id from washingpoints";
