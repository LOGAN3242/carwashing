...
$sql="update  washingpoints set washingPointName=:wpname,washingPointAddress=:wpaddress,contactNumber=:wpcnumber where id=:id";
...
<?php 
$id=$_GET['wpid'];
$sql = "SELECT * from washingpoints where id='$id'";
$query = $dbh -> prepare($sql);
$query->execute();
