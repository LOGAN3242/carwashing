...
$sql="update  carwashbooking set adminRemark=:message,paymentMode=:ttype,txnNumber=:transactionno,status='Completed' where id=:id";
...
<?php 
$bid=$_GET['bid'];
$sql = "SELECT * from carwashbooking
join washingpoints on washingpoints.id=carwashbooking.carWashPoint
 where carwashbooking.id='$bid'";
$query = $dbh -> prepare($sql);
$query->execute();
