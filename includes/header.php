                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="logo">
                            <a href="index.php">
                                ...
                                <h1>Wash<span>&</span>Shine</h1>
                                <!-- <img src="img/logo111.png" alt="Logo" width="300px"> -->
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="col-4">
                                    <div class="top-bar-item">
                                        ...
                                        <div class="top-bar-text">
                                            ...
                                            <p>+91 <a style="color: #444444;" href="tel:<?php echo $result->phoneNumber; ?>"><?php echo $result->phoneNumber; ?></p></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="top-bar-item">
                                        ...
                                        <div class="top-bar-text">
                                            ...
                                            <p>
                                                ...
                                                <a style="color: #444444;" href="mailto:<?php echo $result->emailId; ?>">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <!-- <a href="appointment.php" class="nav-item nav-link">Contact</a>appointment -->
